...
### URL Examples
- Users v1: `GET http://localhost:5019/api/v1/users`
- Users v2: `GET http://localhost:5019/api/v2/users`
- Scores v1: `GET http://localhost:5019/api/v1/scores`
- Scores v2: `GET http://localhost:5019/api/v2/scores`

### Version-Neutral Endpoint
- Delete User: `DELETE http://localhost:5019/api/users/{id}`

## OpenAPI Documents

- v1: `GET http://localhost:5019/openapi/v1.json`
- v2: `GET http://localhost:5019/openapi/v2.json`
