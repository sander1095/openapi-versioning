...
internal static class OpenApiOptionsExtensions
{
    ...
    /// The Example value is read by OpenAPI tools (e.g. Scalar) to pre-fill the field.
    /// For Swagger UI using Swashbuckle, the equivalent is <see cref="ApiVersionParameterExampleFilter"/>.
    /// </summary>
