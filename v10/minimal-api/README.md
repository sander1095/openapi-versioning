...
This folder contains Minimal API implementations of API versioning using `Asp.Versioning` 10.x and `Microsoft.AspNetCore.OpenApi` 10.x — the new built-in OpenAPI stack that replaces Swashbuckle/NSwag. It also includes examples of Scalar and SwaggerUI integration.
...
URL segment-based API versioning with Swagger UI.
- **Port**: 5016
- **Versioning**: URL path (`/api/v1/users`)
